...
import { DailySchedule, Side, Time } from '../db/schedulesSchema.js';
...
const scheduleAdjustment = (timeZone: TimeZone, side: Side, time: Time, temperature: number) => {
...
export const scheduleTemperatures = (settingsData: Settings, side: Side, temperatures: DailySchedule['temperatures']) => {
